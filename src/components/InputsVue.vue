<template>
    <div class="divExplanation">
        ...
        <h3>{{ text }}</h3>
        <p>
            <strong>Detalhe importante:</strong> a trabalheira fica grande caso a variável esteja em outro componente em
            relação ao input
        </p>
        <p>
            <strong>Conclusão:</strong> sempre que possível, declare a variável no mesmo lugar em que ela será alterada
        </p>
    </div>
</template>
