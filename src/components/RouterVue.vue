<template>
    <div class="divExplanation">
        ...
        <hr />
        <h1>Interações</h1>
        <h3>Este input muda o valor da URL</h3>
        <input v-model="inputValue" @input="atualizarRota" />
        <p>Rota atual: <strong>{{ inputValue }}</strong></p>
    </div>
</template>
...
<script>
    export default {
        ...
        mounted() {
            this.inputValue = this.$route.params.input
        },
        methods: {
            atualizarRota() {
